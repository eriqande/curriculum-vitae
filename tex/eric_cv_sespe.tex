%%%%%%%%%%% NOTE:
%%%% This must be compiled under XeLaTeX
%%%% You gotta run biber like this:
%%%% biber --output_safechars eric_cv_sespe
...
Sespe Statistical Genetics  LLC          &        Email~1: \texttt{eriq@rams.colostate.edu}   \\ 
1808 West Mountain Ave.                    &    Email~2: \texttt{sespe.stat.gen@gmail.com}      \\
Fort Collins, CO 80521                         & +1 (831) 227-4239\\
USA                                                      &  
\end{tabular*}
\vspace*{\postskip}
\nopagebreak
...
\begin{tabular}{ @{}p{2.5\myindent} p{\scndcol}@{}  }
\hspace*{\myindent}2025-- & Founder and Lead Scientist, Sespe Statistical Genetics LLC, Fort Collins, Colorado.
\\
\end{tabular}
...
\begin{tabular}{ @{}p{2.5\myindent} p{\scndcol}@{}  }
\hspace*{\myindent}2020,22,24 &  Instructor.  Practical Computing and Bioinformatics for Conservation and Evolutionary Genomics. Course co-taught with Dr. Kristen Ruegg at Colorado State University, with remote students attending from UCSC. Spring.
\end{tabular}

\begin{tabular}{ @{}p{2.5\myindent} p{\scndcol}@{}  }
\hspace*{\myindent}2017--25 &  Instructor.  ConGen: Population Genomics and Conservation Genetics Course. Delivered lecture on Bayesian inference in conservation genomics and led practical sessions on microhaplotypes and other software use. Sept.
\end{tabular}
...
\printbibliography[type=inbook, heading=inbook]
\printbibliography[type=report, heading=report]
\printbibliography[type=inproceedings, heading=inproceedings]
...
{\bf SELECTED SOFTWARE AUTHORED}
\begin{description}
\item[]\href{https://github.com/eriqande/mega-non-model-wgs-snakeflow}{\texttt{mega-non-model-wgs-snakeflow}}: A Snakemake workflow for processing paired-end sequencing reads to obtain variant data.  Includes trimming, QC, mapping, variant-calling, and filtering steps.  
\item[]\href{https://github.com/eriqande/CKMRsim}{\texttt{CKMRsim}}: R package for identifying kin using molecular markers and assessing the power thereof for CKMR.
...
\item[] {\sc Anderson, E.C.} (2008) ``Further adventures in biasing the predicted accuracy of GSI: `high-grading' loci and `beefing-up' your baseline,'' Coastwide Salmonid Genetics Meeting, Olympia, Washington. June. 
